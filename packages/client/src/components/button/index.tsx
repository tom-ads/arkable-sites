...
export const buttonStyles = cva(
  "outline-none font-semibold transition-all flex items-center justify-center gap-2 border border-grey-950",
  {
    variants: {
      intent: {
        primary: [
      ...
      size: {
        ...
        large:
          "text-base py-[0.625rem] px-8 active:shadow-focus-lg rounded-3xl",
      },
      danger: {
        true: "text-white",
      },
